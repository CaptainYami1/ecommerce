...
const Reviews = (props:any) => {
  ...
  return (
    <>
    <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-8 -mx-4">
  <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
    <div className="flex items-center gap-2">
      ...
      <div className="mt-2 flex items-center gap-2 sm:mt-0">
        <div className="flex items-center gap-0.5">
          <svg className="h-4 w-4 text-teal-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div className="my-6 gap-8 sm:flex sm:items-start md:my-8">
      <div className="shrink-0 space-y-4">
        ...
        <button type="button" data-modal-target="review-modal" data-modal-toggle="review-modal" className="mb-2 me-2 rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium bg-teal-600 text-white hover:bg-teal-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Write a review</button>
      </div>

      <div className="mt-6 min-w-0 flex-1 space-y-3 sm:mt-0">
        <div className="flex items-center gap-2">
          <p className="w-2 shrink-0 text-start text-sm font-medium leading-none text-gray-900 dark:text-white">5</p>
          <svg className="h-4 w-4 shrink-0 text-teal-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            <path d="M13.849 4.22c-.684-1.626-3.014-1.626-3.698 0L8.397 8.387l-4.552.361c-1.775.14-2.495 2.331-1.142 3.477l3.468 2.937-1.06 4.392c-.413 1.713 1.472 3.067 2.992 2.149L12 19.35l3.897 2.354c1.52.918 3.405-.436 2.992-2.15l-1.06-4.39 3.468-2.938c1.353-1.146.633-3.336-1.142-3.477l-4.552-.36-1.754-4.17Z" />
          </svg>
          <div className="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
            <div className="h-1.5 rounded-full bg-teal-600" style={{width: "20%"}}></div>
          </div>
          <a href="#" className="w-8 shrink-0 text-right text-sm font-medium leading-none text-teal-700 hover:underline dark:text-teal-500 sm:w-auto sm:text-left">239 <span className="hidden sm:inline">reviews</span></a>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
            <div className="h-1.5 rounded-full bg-teal-600" style={{width: "60%"}}></div>
          </div>
          <a href="#" className="w-8 shrink-0 text-right text-sm font-medium leading-none text-teal-700 hover:underline dark:text-teal-500 sm:w-auto sm:text-left">432 <span className="hidden sm:inline">reviews</span></a>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
            <div className="h-1.5 rounded-full bg-teal-600" style={{width: "15%"}}></div>
          </div>
          <a href="#" className="w-8 shrink-0 text-right text-sm font-medium leading-none text-teal-700 hover:underline dark:text-teal-500 sm:w-auto sm:text-left">53 <span className="hidden sm:inline">reviews</span></a>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
            <div className="h-1.5 rounded-full bg-teal-600" style={{width: "5%"}}></div>
          </div>
          <a href="#" className="w-8 shrink-0 text-right text-sm font-medium leading-none text-teal-700 hover:underline dark:text-teal-500 sm:w-auto sm:text-left">32 <span className="hidden sm:inline">reviews</span></a>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
            <div className="h-1.5 rounded-full bg-teal-600" style={{width: "0%"}}></div>
          </div>
          <a href="#" className="w-8 shrink-0 text-right text-sm font-medium leading-none text-teal-700 hover:underline dark:text-teal-500 sm:w-auto sm:text-left">13 <span className="hidden sm:inline">reviews</span></a>
        </div>
      </div>
    </div>
    ...
    <div className="mt-6 divide-y divide-gray-200 dark:divide-gray-700">
      <div className="gap-3 pb-6 sm:flex sm:items-start">
        ...
        <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
          <p className="text-base font-normal text-gray-500 dark:text-gray-400">Sed scelerisque ac diam eu vestibulum. Integer ullamcorper vitae lacus ac tempor. Morbi non lectus euismod, congue massa dictum, tincidunt ipsum.</p>

          <div className="flex items-center gap-4">
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Was it helpful to you?</p>
            <div className="flex items-center">
              <input id="reviews-radio-1" type="radio" value="" name="reviews-radio" className="h-4 w-4 border-gray-300 bg-gray-100 text-teal-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
              <label htmlFor="reviews-radio-1" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Yes: 3 </label>
            </div>
            <div className="flex items-center">
              <input id="reviews-radio-2" type="radio" value="" name="reviews-radio" className="h-4 w-4 border-gray-300 bg-gray-100 text-teal-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
      ...
      <div className="gap-3 py-6 sm:flex sm:items-start">
        ...
        <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
          <p className="text-base font-normal text-gray-500 dark:text-gray-400"> Mauris iaculis pellentesque lacus, in blandit arcu commodo eu. Pellentesque a metus tincidunt, ullamcorper sem non, vestibulum leo. Aenean fringilla consectetur augue, vel mattis nulla pulvinar ac.</p>

          <div className="flex gap-2">
            <img className="h-32 w-20 rounded-lg object-cover" src={props.image} alt="" />
            <img className="h-32 w-20 rounded-lg object-cover" src={props.image} alt="" />
          </div>
          ...
          <div className="flex items-center gap-4">
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Was it helpful to you?</p>
            <div className="flex items-center">
              <input id="reviews-radio-3" type="radio" value="" name="reviews-radio-2" className="h-4 w-4 border-gray-300 bg-gray-100 text-teal-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
              <label htmlFor="reviews-radio-3" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Yes: 1 </label>
            </div>
            <div className="flex items-center">
              <input id="reviews-radio-4" type="radio" value="" name="reviews-radio-2" className="h-4 w-4 border-gray-300 bg-gray-100 text-teal-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
      ...
      <div className="gap-3 py-6 sm:flex sm:items-start">
        ...
        <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
          <p className="text-base font-normal text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris et elit porta tortor dignissim aliquet in ut odio. Sed elementum ex eu odio tincidunt, ut tempor tortor maximus</p>

          <div className="flex items-center gap-4">
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Was it helpful to you?</p>
            <div className="flex items-center">
              <input id="reviews-radio-5" type="radio" value="" name="reviews-radio-3" className="h-4 w-4 border-gray-300 bg-gray-100 text-teal-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
              <label htmlFor="reviews-radio-5" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Yes: 0 </label>
            </div>
            <div className="flex items-center">
              <input id="reviews-radio-6" type="radio" value="" name="reviews-radio-3" className="h-4 w-4 border-gray-300 bg-gray-100 text-teal-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
      ...
      <div className="gap-3 py-6 sm:flex sm:items-start">
        ...
        <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
          <p className="text-base font-normal text-gray-500 dark:text-gray-400">Sed id velit vel neque pretium porta vel id lorem. Integer ultricies libero sed nisi pharetra maximus. Nulla sit amet odio et elit fermentum euismod nec et elit. Vestibulum egestas nunc in malesuada semper. Integer sit amet lectus tellus.</p>
          <p className="text-base font-normal text-gray-500 dark:text-gray-400">Proin sagittis, velit id lacinia pharetra, tortor elit vestibulum nulla, nec pharetra ante sapien in libero. Suspendisse pellentesque justo quis purus eleifend, et iaculis augue malesuada. In hac habitasse platea dictumst. Duis quis massa eget tortor dapibus iaculis at vitae ipsum. Aliquam eu nisi diam. Curabitur magna quam, tincidunt eu ipsum vitae, molestie varius nunc. Quisque molestie arcu et mi finibus, id porta lectus venenatis.</p>

          <div className="flex items-center gap-4">
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Was it helpful to you?</p>
            <div className="flex items-center">
              <input id="reviews-radio-7" type="radio" value="" name="reviews-radio-4" className="h-4 w-4 border-gray-300 bg-gray-100 text-teal-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
              <label htmlFor="reviews-radio-7" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Yes: 1 </label>
            </div>
            <div className="flex items-center">
              <input id="reviews-radio-8" type="radio" value="" name="reviews-radio-4" className="h-4 w-4 border-gray-300 bg-gray-100 text-teal-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
      ...
      <div className="gap-3 py-6 sm:flex sm:items-start">
        ...
        <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
          <p className="text-base font-normal text-gray-500 dark:text-gray-400">Pellentesque tincidunt arcu ut lacinia placerat. Etiam tempor convallis ullamcorper. Morbi feugiat congue diam quis euismod. Integer condimentum ex nisl, bibendum finibus dui feugiat at. In porta tortor sed maximus scelerisque. Mauris laoreet blandit mi. </p>

          <div className="flex items-center gap-4">
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Was it helpful to you?</p>
            <div className="flex items-center">
              <input id="reviews-radio-9" type="radio" value="" name="reviews-radio-5" className="h-4 w-4 border-gray-300 bg-gray-100 text-teal-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
              <label htmlFor="reviews-radio-9" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Yes: 1 </label>
            </div>
            <div className="flex items-center">
              <input id="reviews-radio-10" type="radio" value="" name="reviews-radio-5" className="h-4 w-4 border-gray-300 bg-gray-100 text-teal-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
